...
<%
    ...
    String agendaIdStr = request.getParameter("agendaId");
    int agendaId = Integer.parseInt(agendaIdStr);

    // Crear un HashMap para almacenar los parámetros del informe
    HashMap<String, Object> parameters = new HashMap<>();
    System.out.println("Valor de agendaId: " + agendaId); // Imprime el valor de agendaId en la consola
    ...
    File reportFile = new File(application.getRealPath("Reportes/Candidatos.jasper"));
